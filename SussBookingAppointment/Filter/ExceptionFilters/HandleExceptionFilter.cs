...
namespace SussBookingAppointment.Filter.ExceptionFilters
{
    ...
    public class HandleExceptionFilter : IExceptionFilter
    {
        ...
        void IExceptionFilter.OnException(ExceptionContext context)
        {
            _logger.LogError("Exception filter {FilterName}.{MethodName}\n{ExceptionType}\n{ExceptionMessage}", 
                nameof(HandleExceptionFilter), nameof(IExceptionFilter.OnException), context.Exception.GetType().ToString(), 
